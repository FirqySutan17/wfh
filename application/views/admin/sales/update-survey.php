...
<div class="main-content pre-posttest">
    ...
    <div class="row">
        <form action="<?= admin_url('sales/survey-market/update') ?>" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="table-responsive">
                            ...
                            <tbody>
                                <tr>
                                    <td data-label="SURVEY NUMBER">
                                        <input type="text" class="form-control" style="font-size: 13px; width: 100%" name="survey_no" value="#<?= $survey['SURVEY_NO'] ?>" readonly>
                                    </td> 
                                    <td data-label="DATE">
                                        <input type="text" class="form-control" style="font-size: 13px; width: 100%" name="survey_date" value="<?= $survey['SURVEY_DATE'] ?>" readonly>
                                    </td> 
                                    <td data-label="SALES NAME">
                                        <input type="hidden" name="sales_npk" value="<?= $survey['SALES_NPK'] ?>">
                                        <input type="text" name="sales_name" class="form-control" style="font-size: 13px; width: 100%" value="<?= $survey['SALES_NPK'] ?> - <?= $survey['SALES_NAME'] ?>" readonly>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
                        ...
                        <table class="table table-bordered" style="margin-bottom: 0px">
                            ...
                            <tbody>
                                <tr>
                                    <td data-label="TITLE">
                                        <input type="text" class="form-control" style="font-size: 13px; width: 100%; text-transform: uppercase" name="title" value="<?= $survey['TITLE'] ?>" placeholder="INPUT TITLE.." readonly />
                                    </td> 
                            ...
                            <tbody>
                                <tr>
                                    <td data-label="TARGET SURVEY">
                                        <textarea type="text" class="form-control" style=" font-size: 13px; width: 100%; padding: 10px; text-transform: uppercase" placeholder="INPUT TARGET SURVEY..." name="target_survey" rows="5"><?= $survey['TARGET_SURVEY'] ?></textarea>
                                    </td>  
                                </tr>
                            </tbody>
                        </table>
                            ...
                            <tbody>
                                <tr>
                                    <td data-label="COORDINATE">
                                        ...
                                        <input type="text" style="margin-top: 10px !important" placeholder="KLIK TOMBOL DIBAWAH UNTUK DAPAT KOORDINATE" name="coordinate" class="form-control" value="<?= $survey['COORDINATE'] ?>" readonly>
                                        <textarea name="addresscoor" class="form-control" rows="5" readonly style="margin-top:10px; text-transform: uppercase; font-size: 13px" id="address-info"><?= $survey['ADDRESS'] ?></textarea>
                                    </td>
                                    <td data-label="RESULT SURVEY">
                                        <textarea name="hasil_survey" style="padding: 10px; text-transform: uppercase; font-size: 13px" placeholder="INPUT RESULT SURVEY.." rows="6" class="form-control"><?= $survey['HASIL_SURVEY'] ?></textarea>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
                        ...
                        <table class="table table-bordered" style="margin-bottom: 20px">
                            ...
                            <tbody>
                                <tr>
                                    <td data-label="NAME">
                                        <input type="text" class="form-control" style="font-size: 13px; width: 100%; text-transform: uppercase" name="contact_name" value="<?= $survey['CONTACT_NAME'] ?>" placeholder="INPUT NAME.." required />
                                    </td> 
                                    <td data-label="PHONE">
                                        <input type="number" class="form-control" style="font-size: 13px; width: 100%; text-transform: uppercase" name="contact_phone" value="<?= $survey['CONTACT_PHONE'] ?>" placeholder="INPUT PHONE.." required />
                                    </td> 
                                </tr>
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody id="customersinfo">
                                ...
                                <?php if (!empty($other_images)): ?>
                                    <?php foreach ($other_images as $i => $other): ?>
                                    <tr>
                                        <td data-label ="UPLOAD IMAGE">
                                            <input type="hidden" name="other_id[]" value="">
                                             <?php if (!empty($other['IMAGE_PATH'])): ?>
                                                <div style="margin-bottom: 10px;">
                                                    <img src="<?= base_url('uploads/market/' . $other['IMAGE_PATH']) ?>" alt="Existing Image" style="max-width: 150px; border: 1px solid #ccc; padding: 5px;">
                                                    <br>
