...
<div class="main-content pre-posttest">
    <h3 class="card-title">
        <strong>MASTER DATA - PLAZMA</strong>
    </h3>
        ...
        <tbody>
            <?php foreach ($datatable as $i => $v): ?>
                <tr>
                    ...
                    <td style="text-align: center; vertical-align: middle"><?= $v['PLANT'].'<br/>'.$v['PLANT_NAME'] ?></td>
                    <td style="text-align: center; vertical-align: middle">
                        <?= $v['PLAZMA'].' - '.$v['PLAZMA_NAME'] ?>
                    </td>
                    <td style="text-align: center; vertical-align: middle">
                        <?= $v['ADDRESS'] ?> 
                    </td>
                    <td style="text-align: center; vertical-align: middle"><?= $v['OWNER'].'<br/>'.$v['PHONE'] ?></td>
                </tr>
            <?php endforeach ?>
        </tbody>
    </table>
