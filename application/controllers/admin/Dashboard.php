...
class Dashboard extends CI_Controller {
	...
	public function check_in()
    {
        if ($this->session->userdata('empno') == true) {
            ...
            if ($meters>300 || $this->session->userdata('empno') == '220014' || $this->session->userdata('empno') == '220023' || $this->session->userdata('empno') == '220021' || $this->session->userdata('empno') == '220015') {
